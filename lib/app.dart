...
class ProductApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(create: (context) => ProductListBloc(productRepository: sl<ProductRepository>())..add(ProductListFetched())),
        BlocProvider(create: (context) => ProductCategoryCubit(productRepository: sl<ProductRepository>())..fetchProductCategory()),
      ],
